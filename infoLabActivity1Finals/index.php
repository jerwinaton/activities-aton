...
<body>
    ...
    <div class="container">
        ...
        <div id="show_alert"></div>
                ...
                <div class="col-6">
                    <a class ="btn btn-primary"href="export.php">Download as Excel File</a>
                </div>
...
$add = "INSERT INTO activity1Finals (l_name, stud_f_name, stud_m_initial, stud_age, stud_address, brgy, municipality, zip_code, stud_bday, stud_gender, stud_status, father_name,father_age,father_occup,mother_name,mother_age,mother_occup,sibling1_name,sibling1_age,sibling2_name,sibling2_age,sibling3_name,sibling3_age,sibling4_name,sibling4_age,sibling5_name,sibling5_age,sibling6_name,sibling6_age) VALUES ('$last_name','$first_name','$middle_initial','$stud_age','$address','$brgy','$municipality','$zip_code','$stud_bday','$stud_gender','$stud_status','$father_name','$father_age','$father_occup','$mother_name','$mother_age','$mother_occup','$sibling1_name','$sibling1_age','$sibling2_name','$sibling2_age','$sibling3_name','$sibling3_age','$sibling4_name','$sibling4_age','$sibling5_name','$sibling5_age','$sibling6_name','$sibling6_age')";
